...
Utilizzo del Tridentlink:https://netapp.github.io/trident-helm-chart["Grafico del timone"^] è possibile distribuire l'operatore Trident e installare Trident in un unico passaggio.
