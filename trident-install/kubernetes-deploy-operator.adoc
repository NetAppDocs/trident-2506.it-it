...
Ora puoi creare il `TridentOrchestrator` e installare Trident.  Facoltativamente, puoilink:kubernetes-customize-deploy.html["personalizza la tua installazione Trident"] utilizzando gli attributi nel `TridentOrchestrator` specifiche.
