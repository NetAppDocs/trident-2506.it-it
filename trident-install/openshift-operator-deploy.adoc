...
---
= Installa Trident utilizzando OpenShift OperatorHub
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Se utilizzi Red Hat OpenShift, puoi installare NetApp Trident utilizzando l'operatore certificato Red Hat.  Utilizzare questa procedura per installare Trident da Red Hat OpenShift Container Platform.
...
.Passi
. Vai su OpenShift OperatorHub e cerca NetApp Trident.
+
