...
In generale, dovresti eseguire l'aggiornamento utilizzando lo stesso metodo usato per l'installazione iniziale, tuttavia puoi link:../trident-install/kubernetes-deploy.html#moving-between-installation-methods["spostarsi tra i metodi di installazione"]. Ci sono due opzioni per aggiornare Trident.
