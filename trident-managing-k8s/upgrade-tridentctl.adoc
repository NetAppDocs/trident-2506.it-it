...
.Prima di iniziare
Rivedi link:upgrade-trident.html#step-3-select-an-upgrade-method["Seleziona un metodo di aggiornamento"] prima di aggiornare usando `tridentctl`.
...
----
. Reinstallare Trident. Fare riferimento a link:../trident-install/kubernetes-deploy-tridentctl.html["Installa Trident usando tridentctl"].
