...
summary: 'Trident Protect utilizza il modello Kubernetes di controllo degli accessi basato sui ruoli (RBAC). È possibile utilizzare le funzionalità di protezione RBAC Trident per controllare in modo più preciso l"accesso alle risorse.' 
---
