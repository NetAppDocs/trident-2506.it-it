...
summary: È possibile monitorare lo stato delle risorse Trident Protect utilizzando kube-state-metrics e Prometheus. In questo modo vengono fornite informazioni sullo stato di implementazione, sui nodi e sui pod. 
---
