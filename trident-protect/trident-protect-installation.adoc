...
----
. Creare lo spazio dei nomi del sistema di protezione Trident :
+
[source, console]
----
...
helm repo add netapp-trident-protect https://netapp.github.io/trident-protect-helm-chart
----
. Crea un file denominato `protectValues.yaml` .  Assicurarsi che contenga le seguenti impostazioni di protezione Trident :
+
[source, yaml]
----
---
