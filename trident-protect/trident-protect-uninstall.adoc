...
summary: 'Potrebbe essere necessario rimuovere i componenti Trident Protect se si esegue l"aggiornamento da una versione di prova a una versione completa del prodotto.' 
---
...
.Passi
. Rimuovere i file CR Trident Protect:
+
