...
* Aggiunta la possibilità di configurare vincoli di contesto di sicurezza (SCC) durante l'installazione Trident Protect.
...
NetApp sta migliorando e perfezionando continuamente i suoi prodotti e servizi. Ecco alcune delle ultime funzionalità di Trident. Per le versioni precedenti, fare riferimento alle versioni precedenti della documentazione.
