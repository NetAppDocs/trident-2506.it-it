...
Trident può creare volumi Cloud Volumes Service in uno dei due link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["tipi di servizio"^]:

* *CVS-Performance*: Il tipo di servizio Trident predefinito. Questo tipo di servizio ottimizzato per le prestazioni è ideale per carichi di lavoro di produzione che danno valore alle prestazioni. Il tipo di servizio CVS-Performance è un'opzione hardware che supporta volumi con una dimensione minima di 100 GiB. Puoi scegliere uno dei seguenti link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["tre livelli di servizio"^]:
+
** `standard`
** `premium`
** `extreme`
