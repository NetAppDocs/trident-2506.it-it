...
----
Per maggiori informazioni fare riferimento alink:https://docs.aws.amazon.com/eks/latest/userguide/pod-id-agent-setup.html["Configurare l'agente di identità del pod Amazon EKS"] .
